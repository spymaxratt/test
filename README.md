<p align="center">
<img src="https://github.com/spymaxratt/test/raw/master/server/assets/webpublic/logo.png" height="60"><br>
...
5. Go to server directory
   - `cd ANDROID~RAT 2.0/server/`

5. In the server directory, run these commands
    - `npm install` <- install dependencies
    - `pm2 start index.js` <-- start the script
    - `pm2 startup` <- to run ANDROID~RAT 2.0 on startup
...
It's recommended to run ANDROID~RAT 2.0 behind a reverse proxy such as [NGINX](https://www.nginx.com/resources/wiki/start/topics/tutorials/install/)
...
ANDROID~RAT 2.0 is built for Educational Purpose. Use at your own Risk.</b>

<br>
<p align="center">MADE WITH ❤️ BY <a href="https://JAYADEEP KHETRI.com">JAYADEEP KHETRI</a></p>
